...
export default function MenuFilter() {
  ...
  const contextValor = valor; // Alias if needed
  ...
  const operation = [
    { icon: Building2, nombre: 1, titulo: "Venta" },
    { icon: Building, nombre: 2, titulo: "Renta" },
  ];

  const handleLimpiarFiltros = () => {
    // Limpiar todos los filtros (React state controla los checkboxes)
    setPrecioMinimo(0);
      ...
      >
        ...
        <form className="mt-10 w-full font-lightitalic">
          ...
          <div className="rounded-[8px] mt-2 gap-3 ">
            ...
            >
              <div className="z-50   flex text-base flex-col items-end  mt-1 px-4">
                {operation.map(({ icon: IconComponent, nombre, titulo }, index) => (
                  <div
                    key={index}
                    className="flex justify-between items-center mb-4"
                  >
            ...
            >
              <div className="z-50 overflow-y-scroll h-60  flex text-base flex-col items-end   mt-1 px-4 ">
                {propiedadesFiltradas.map(
                  ({ icon: IconComponent, nombre, tipo_id }, index) => (
                    <div
                      key={tipo_id}
                      className="flex justify-between items-center mb-4"
                    >
