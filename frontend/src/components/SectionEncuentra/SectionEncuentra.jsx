...
export default function SectionEncuentra() {
  return (
    <div className="px-5 py-10 font-display bg-blueRemax/10 flex flex-col justify-center items-center text-center">
      <p className="text-2xl  text-[#2e2c2c]">
      ...
      <p className="text-base text-[#2e2c2c] mt-3 sm:w-4xl">
        ...
        personalizada, hacemos que cada paso sea claro y sin complicaciones.
      </p>
    </div>
  );
}
