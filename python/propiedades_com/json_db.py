...
class PropertyDB:
    """
    Motor de base de datos JSON profesional para el scraper de Propiedades.com.
    ...
    def __init__(self, db_path: str):
        ...
        self._data: Dict[str, Any] = {
            "project": "Propiedades.com Scraper DB",
            "version": "1.0",
            "metadata": {
    ...
    def _load(self):
        ...
        if os.path.exists(self.db_path):
            try:
                ...
                logger.info(f"Base de datos cargada: {len(self._data['listings'])} registros existentes.")
    ...
    def upsert(self, url: str, property_data: Dict[str, Any], autosave: bool = True) -> bool:
        ...
        Retorna True si hubo cambios o es nuevo.
    ...
    def get_all_as_list(self) -> List[Dict[str, Any]]:
        """Devuelve todos los registros aplanados para exportar a CSV/Excel."""
        flat_list = []
