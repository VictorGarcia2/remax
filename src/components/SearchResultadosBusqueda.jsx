...
export default function SearchResultadosBusqueda() {
  return (
    <div className="flex justify-center px-5 gap-4">
      ...
      <input
        className=" font-display text-[#414141] appearance-none ring-0 focus:ring-0 focus:shadow-none focus:outline-none border-none focus:border-none"
        type="search"
        name="search"
        id=""
      ...
      <img src="HomePageContent/Filter.svg" alt="" />
    </div>
  );
}
